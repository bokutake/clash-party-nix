...
in
{
  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      ...
      {
        assertion = builtins.pathExists "${cfg.package}/lib/clash-party/resources/nix-sidecar-store";
        message = "programs.clash-party.package must provide lib/clash-party/resources/nix-sidecar-store.";
      }
    ];
